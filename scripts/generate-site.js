...
function renderStyles() {
  return [
    ...
    ".calendar-event-pill { display: flex; align-items: center; width: 85%; max-width: 85%; min-width: 0; padding: 8px 10px; border-radius: 12px; background: #ddf3ee; border: 1px solid #8ecabf; text-decoration: none; color: var(--accent-strong); font-size: 11px; line-height: 1.25; overflow-wrap: anywhere; word-break: break-word; }",
